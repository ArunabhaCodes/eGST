...
```{r load_pheno, eval=FALSE, collapse = TRUE}
library("eGST")
...
```{r load_geno, eval=FALSE, collapse = TRUE}
library("eGST")
...
```{r example_run_eGST, eval=FALSE, collapse = TRUE}
...
See our manuscript for more details: Majumdar A, Giambartolomei C, Cai N, Freund MK, Haldar T, J Flint, Pasaniuc B (2019) Leveraging eQTLs to identify tissue-specific genetic subtype of complex trait. bioRxiv.
